...
// 
//
// Related Topics Array Binary Search Sorting Heap (Priority Queue) Matrix 👍 33
//45 👎 202
    ...
    public int[] kWeakestRows(int[][] mat, int k) {
        ...
        PriorityQueue<Integer> queue = new PriorityQueue<>(new Comparator<Integer>() {
            ...
            public int compare(Integer o1, Integer o2) {
                int o1Sum = 0, o2Sum = 0;
                for (int i : mat[o1]) o1Sum += i;
                for (int i : mat[o2]) o2Sum += i;
                return o1Sum == o2Sum ? o1 - o2 : o1Sum - o2Sum;
            }
        });
        for (int i = 0; i < rows; i++) queue.add(i);
        int[] ans = new int[k];
        for (int i = 0; i < k; i++) {
            ans[i] = queue.poll();
        }
