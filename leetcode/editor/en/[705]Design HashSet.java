...
// 
// Related Topics Array Hash Table Linked List Design Hash Function 👍 2130 👎 2
//09
...
class MyHashSet {
    ...
    public void add(int key) {
        if (!arrayList.contains(key)) arrayList.add(key);
    }

    public void remove(int key) {
        if (arrayList.contains(key)) arrayList.remove(arrayList.indexOf(key));
    }
